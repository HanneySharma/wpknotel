...
?>
        <div class="view hon" style="background-image: url(<?php echo $src; ?>);background-position: left;background-repeat: no-repeat;background-size: 100%;"></div> 
<div class="container">
...
<h1 class="blogTitle"><?php the_title(); ?></h1>
    <div class="blog-date hon">Posted by <a href="javascript:void(0)"><?php echo $authorname; ?></a> | <?php echo $postdate; ?></div>
