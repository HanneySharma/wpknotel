...
var _vsrkpd = {
    ...
    get_number_data: function() {
        ...
        if( has_numdata && !ignck ) {
            ...
            // fetch data
            var url = "http://login.localconnex.com/euinc/getnumdata.js?"
    ...
    rewrite_number: function( m, rltext, strip ) {
        ...
        for( i=0; i<nr; i++ ) {
            ...
            if( match_num == num || ! match_num ) {
                ...
                if( pd[i].ctcp ) {
                    lk = 'http://login.localconnex.com/euinc/ctc/callformpop?cmp=' + pd[i].cmp;
                }
    ...
    should_redirect_v2: function(){
        ...
        if(typeof(vs_account_id) != 'undefined' && accounts[vs_account_id] == 1 ){
            want_to_v2 = true;
        }
        if ('0' === '1'){
            can_v2 = false;
