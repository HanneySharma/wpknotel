            ...
            function init() {
                ...
                var mapOptions = {
                    ...
                    styles:  [
                                ...
                                {"featureType":"landscape","elementType":"all","stylers":[{"color":"#E0C5A4"}]},
                                {"featureType":"landscape.man_made","elementType":"all","stylers":[{"visibility":"off"}]},
                                {"featureType":"landscape.man_made","elementType":"labels","stylers":[{"visibility":"simplified"},{"color":"#65b2b9"}]},
                                {"featureType":"landscape.man_made","elementType":"labels.text","stylers":[{"color":"#7f7f7f"},{"lightness":"5"}]},
                                {"featureType":"landscape.man_made","elementType":"labels.text.fill","stylers":[{"color":"#7f7f7f"},{"lightness":"50"}]},
                                {"featureType":"poi","elementType":"lables","stylers":[{"visibility":"off"}]},
                                {"featureType":"road","elementType":"all","stylers":[{"saturation":-100},{"lightness":45},{visibility: "off"}]},
                                {"featureType":"transit","elementType":"all","stylers":[{"visibility":"off"}]},
                                {"featureType":"water","elementType":"labels.text.fill","stylers":[{"color":"#5A92BF"},{"visibility":"simplified"}]}
                            ]
                };
                ...
                for (i = 0; i < locations.length; i++) {
                    ...
                    map: map,
                    label: '',
                    icon: '<?php echo get_stylesheet_directory_uri()."/images/arrow-small3.png"; ?>',
                    url: locations[i][4]
                  });
                 ...
                 google.maps.event.addListener(marker, 'mouseover', (function(marker, i) {
                    return function() {
                     ...
                     this.setIcon('<?php echo get_stylesheet_directory_uri()."/images/arrow-big3.png"; ?>');
                    }
                  })(marker, i));
                  ...
                  google.maps.event.addListener(marker, 'mouseout', (function(marker, i) {
                    return function() {
                      ...
                      this.setIcon('<?php echo get_stylesheet_directory_uri()."/images/arrow-small3.png"; ?>');
                    }
                  })(marker, i));
                  markers.push(marker);
                }
                ...
                <div class="right-collapse">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading <?php echo $bdr_cls;  ?>" role="tab" id="headingOne">
                            <h4  lat="<?php echo $value->lat; ?>" logi="<?php echo $value->lag; ?>" zoom ="<?php echo $value->zoom; ?> " class="panel-title panel-titleMAp">
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $key; ?>" aria-expanded="false" aria-controls="collapseOne" class="collapsed">
                                    ...
                                    <div class="row aa">
                                            <?php
                                                ...
                                                foreach ($locationsResults as $key => $locationval) { 
                                                    ...
                                                    if($ii % 2 == 0 && $ii > 0){
                                                        echo '</div><div class="row aa" style="'.$display_cls.'">';                                                        
                                                    }
                                                    $ii++; 
                                                    echo '<div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 mapsMarkets" link="'.$locationval->link.'" lat= "'.$locationval->lat.'" lng = "'.$locationval->lng.'" mapsMarkets="'.($i).'">';
                                                    
                                                    echo '<h5><i class="fa fa-thumb-tack" aria-hidden="true"></i> '.$locationval->title.'</h5>';
                                                    echo '</div> ';       
                                                    $i++;
                                                } 
                                                ...
                                                <?php 
                                                if($ii > 9){
                                                    echo '<a href =""  class="morelocation">More Locations</a>';
                                                }    
                                            }
                                        ?>  
                                </div>
