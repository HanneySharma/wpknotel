    ...
    "stylers": [
      {
        "color": "#17263c"
                ...
                for (i = 0; i < locations.length; i++) {
                    ...
                    map: map,
                    label: '',
                    icon: '<?php echo get_stylesheet_directory_uri()."/images/icon-sm.png"; ?>',
                    url: locations[i][4]
                  });
                 ...
                 google.maps.event.addListener(marker, 'mouseover', (function(marker, i) {
                    return function() {
                     ...
                     this.setIcon('<?php echo get_stylesheet_directory_uri()."/images/icon-sm.png"; ?>');
                    }
                  })(marker, i));
                ...
                $(document).on('click','div.mapsMarkets', function(){
...
<section class="map-area">
    ...
    <div id="about">
        ...
        <div id="map" class="map-code"> </div>
      </div>
              <div class="map-location">
        <div class="city-control"> <a href="#" id="closebtn" class="close">× Close Me</a>
        <div class="panel-group city-tabs" id="accordion" role="tablist" aria-multiselectable="true">
        <?php     
        ...
        ?>
            ...
            <div class="panel panel-default">
                      <div class="panel-heading" role="tab" id="headingOne">
                          <a  lat="<?php echo $value->lat; ?>" logi="<?php echo $value->lag; ?>" zoom ="<?php echo $value->zoom; ?> " role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $key; ?>" aria-expanded="false" aria-controls="collapseOne" class="collapsed panel-titleMAp"> <i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $value->regionname; ?> </a>
                      </div>
                    ...
                    <div class="panel-body">
                        ...
                        if(!empty($locationsResults)){
                                echo '<div class="row city-row">';
                                $i= 0;
                                foreach ($locationsResults as $key => $locationval) { 
                                    echo '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mapsMarkets" link="'.$locationval->link.'" lat= "'.$locationval->lat.'" lng = "'.$locationval->lng.'" mapsMarkets="'.($i).'">';
                ...
                <ul id="navigation">
                    <?php
                        ...
                        ?>    
                          ...
                          <li><a href="#about">
                            <div id="newy" class="city-block">
                            <div class="city-img"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/darknewyork<?php echo $imgcount; ?>.jpg">
                                <h3><?php echo $value->regionname; ?> <span class="section-count"> <?php echo $count; ?> Locations </span> </h3>
                              </div>
                          </div>
                            </a>
                          </li>
    ...
    <div id="about">
        ...
        <div class="city-control"> <a href="#" id="closebtn" class="close">× Close Me</a>
                  <div class="panel-group city-tabs" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
                      <div class="panel-heading" role="tab" id="headingOne"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne0" aria-expanded="false" aria-controls="collapseOne" class="collapsed"> <i class="fa fa-map-marker" aria-hidden="true"></i> New York </a> </div>
                      <div id="collapseOne0" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
                <div class="panel-body">
                          <div class="row city-row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>209 N 8th St209 N 8th St</h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>1 State Street</h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>22 West 38th Street </h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>68 Jay Street</h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>33 West 17th Street </h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>116 West Houston Street</h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>30 Cooper Street </h5>
                            </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <h5>50 W 17th St</h5>
                            </div>
            ...
            <div class="panel panel-default">
                      <div class="panel-heading" role="tab" id="headingOne"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne1" aria-expanded="false" aria-controls="collapseOne" class="collapsed"> <i class="fa fa-map-marker" aria-hidden="true"></i> San Francisco </a> </div>
    ...
    <div id="mainpage">
        ...
        <ul id="navigation">
                  <li><a href="#about">
                    <div id="newy" class="city-block">
                    <div class="city-img"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/newyork2.jpg">
                        <h3>New <b> York </b> <span class="section-count"> 8 Locations </span> </h3>
                      </div>
                  </div>
                    </a></li>
                  <li><a href="#about">
                    <div id="sanf" class="city-block">
                    <div class="city-img"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/san2.jpg">
                        <h3>San <b> Francisco </b> <span class="section-count"> 8 Locations </span> </h3>
                      </div>
                  </div>
                    </a></li>
                </ul>
...
<script>
  ...
  $(document).find('#map').height( $('div.right-collapse').outerHeight()  );   
    ...
    $(document).on('click','.morelocation', function(evt){
        evt.preventDefault();
        $('.row.aa').slideDown();
        $(this).fadeOut('fast');
    });
