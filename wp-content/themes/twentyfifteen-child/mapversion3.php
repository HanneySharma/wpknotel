        ...
        google.maps.event.addDomListener(window, 'load', init);
            ...
            function init() {
                ...
                for (i = 0; i < locations.length; i++) {
                    ...
                    map: map,
                    label: '',
                    icon: '<?php echo get_stylesheet_directory_uri()."/images/arrow-small4.png"; ?>',
                    url: locations[i][4]
                  });
                 ...
                 google.maps.event.addListener(marker, 'mouseover', (function(marker, i) {
                    return function() {
                     ...
                     this.setIcon('<?php echo get_stylesheet_directory_uri()."/images/arrow-big4.png"; ?>');
                    }
                  })(marker, i));
                  ...
                  google.maps.event.addListener(marker, 'mouseout', (function(marker, i) {
                    return function() {
                      ...
                      this.setIcon('<?php echo get_stylesheet_directory_uri()."/images/arrow-small4.png"; ?>');
                    }
                  })(marker, i));
                  markers.push(marker);
                }
